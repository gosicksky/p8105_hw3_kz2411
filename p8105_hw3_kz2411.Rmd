...
There are 50400 observations and 6 variables exist in the resulting dataset. The variables are week (numeric), day id (numeric), day (character), minute (numeric), activity (numeric) and day_kind (factor).
...
The man may sleep from 22:00 to 6:00 for this is the time period when there are least activities.
